...
excerpt: >-
  ...
  don't need to mess around copying any node_module folder or dependencies
  around as they are baked right into the output index.js. Steps Add a Webpack
  Config Create a webpack.config.js file in the root of your node project.
hide_header: false
seo:
  title: Using Webpack for AWS Lambda with NodeJs and Typescript.
  description: >-
    How to use Typescript + NodeJS and compile to a single output file using
    Webpack.
  robots: []
  extra: []
